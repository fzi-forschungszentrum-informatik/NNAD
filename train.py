...
with distribution_strategy.scope():
    ...
    @tf.function
    def train_step():
        per_replica_losses = distribution_strategy.extended.call_for_each_replica(single_train_step_fn, args=())
        total_loss = distribution_strategy.reduce(tf.distribute.ReduceOp.MEAN, per_replica_losses, None)
        return total_loss
